...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar SchemaInstruction_1 = __importDefault(__webpack_require__(/*! ../../core/schema/SchemaInstruction */ \"./src/js/core/schema/SchemaInstruction.ts\"));\nvar stripTags_1 = __importDefault(__webpack_require__(/*! ../../functions/stripTags */ \"./src/js/functions/stripTags.ts\"));\n/**\n * SchemaInstruction class.\n */\nvar Attribute = /** @class */ (function (_super) {\n    __extends(Attribute, _super);\n    function Attribute() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    /**\n     * Renders schema.\n     *\n     * @param props The props.\n     *\n     * @returns The schema.\n     */\n    Attribute.prototype.render = function (props) {\n        var html = props.attributes[this.options.name] || this.options.default;\n        return stripTags_1.default(html, this.options.allowedTags);\n    };\n    return Attribute;\n}(SchemaInstruction_1.default));\nexports.default = Attribute;\nSchemaInstruction_1.default.register(\"attribute\", Attribute);\n\n\n//# sourceURL=webpack:///./src/js/instructions/schema/Attribute.ts?");
...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar data_1 = __webpack_require__(/*! @wordpress/data */ \"@wordpress/data\");\nvar SchemaInstruction_1 = __importDefault(__webpack_require__(/*! ../../core/schema/SchemaInstruction */ \"./src/js/core/schema/SchemaInstruction.ts\"));\nvar SchemaDefinition_1 = __webpack_require__(/*! ../../core/schema/SchemaDefinition */ \"./src/js/core/schema/SchemaDefinition.ts\");\n/**\n * InnerBlocks instruction\n */\nvar InnerBlocks = /** @class */ (function (_super) {\n    __extends(InnerBlocks, _super);\n    function InnerBlocks() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    /**\n     * Renders schema.\n     *\n     * @param props The props.\n     *\n     * @returns The schema.\n     */\n    InnerBlocks.prototype.render = function (props) {\n        var _this = this;\n        var innerBlocks = data_1.select(\"core/block-editor\").getBlocksByClientId(props.clientId)[0].innerBlocks;\n        if (this.options.blocks) {\n            innerBlocks = innerBlocks.filter(function (block) { return _this.options.blocks.includes(block.name); });\n        }\n        return innerBlocks.map(function (block) {\n            var schemaDefinition = SchemaDefinition_1.schemaDefinitions[block.name];\n            if (!schemaDefinition) {\n                return null;\n            }\n            return schemaDefinition.render(block);\n        }).filter(function (schema) { return schema !== null; });\n    };\n    return InnerBlocks;\n}(SchemaInstruction_1.default));\nSchemaInstruction_1.default.register(\"inner-blocks\", InnerBlocks);\n\n\n//# sourceURL=webpack:///./src/js/instructions/schema/InnerBlocks.ts?");
