...
/***/ "./src/js/instructions/schema/Echo.ts":
/*!********************************************!*\
  !*** ./src/js/instructions/schema/Echo.ts ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar SchemaInstruction_1 = __webpack_require__(/*! ../../core/schema/SchemaInstruction */ \"./src/js/core/schema/SchemaInstruction.ts\");\n/**\n * SchemaInstruction class.\n */\nvar Echo = /** @class */ (function (_super) {\n    __extends(Echo, _super);\n    function Echo() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    /**\n     * Renders schema.\n     *\n     * @param props The props.\n     *\n     * @returns The schema.\n     */\n    Echo.prototype.render = function (props) {\n        return props.attributes[this.options.name] || this.options.default || \"\";\n    };\n    return Echo;\n}(SchemaInstruction_1.default));\nexports.default = Echo;\nSchemaInstruction_1.default.register(\"echo\", Echo);\n\n\n//# sourceURL=webpack:///./src/js/instructions/schema/Echo.ts?");

/***/ }),

/***/ "./src/js/instructions/schema/StripHTML.ts":
/*!*************************************************!*\
  !*** ./src/js/instructions/schema/StripHTML.ts ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar SchemaInstruction_1 = __webpack_require__(/*! ../../core/schema/SchemaInstruction */ \"./src/js/core/schema/SchemaInstruction.ts\");\nvar stripTags_1 = __webpack_require__(/*! ../../functions/stripTags */ \"./src/js/functions/stripTags.ts\");\n/**\n * SchemaInstruction class.\n */\nvar StripHTML = /** @class */ (function (_super) {\n    __extends(StripHTML, _super);\n    function StripHTML() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    /**\n     * Renders schema.\n     *\n     * @param props The props.\n     *\n     * @returns The schema.\n     */\n    StripHTML.prototype.render = function (props) {\n        var html = props.attributes[this.options.name] || this.options.default;\n        var allowedTags = this.options.allowedTags || [];\n        return stripTags_1.default(html, allowedTags);\n    };\n    return StripHTML;\n}(SchemaInstruction_1.default));\nexports.default = StripHTML;\nSchemaInstruction_1.default.register(\"strip-html\", StripHTML);\n\n\n//# sourceURL=webpack:///./src/js/instructions/schema/StripHTML.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\n__webpack_require__(/*! ./Echo */ \"./src/js/instructions/schema/Echo.ts\");\n// Import \"./InnerBlocks\";\n__webpack_require__(/*! ./StripHTML */ \"./src/js/instructions/schema/StripHTML.ts\");\n\n\n//# sourceURL=webpack:///./src/js/instructions/schema/index.ts?");
